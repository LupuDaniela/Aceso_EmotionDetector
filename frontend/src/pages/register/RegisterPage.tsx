    ...
    <div className={styles.bg}>
      <div className={`${styles.card} ${mounted ? styles.visible : ''}`}>
        <div className={styles.left}>
          ...
          <p className={styles.greeting}>Creează un cont nou</p>

          <div className={styles.tabs}>
            <Link to="/login" style={{ flex: 1, textDecoration: 'none' }}>
              <button className={styles.tab} style={{ width: '100%' }}>Autentificare</button>
            </Link>
            <button className={`${styles.tab} ${styles.active}`}>Înregistrare</button>
          </div>
          ...
          <form onSubmit={handleRegister}>
            <div className={styles.field}>
              ...
              <input className={styles.input} type="text" placeholder="Ion Popescu"
            ...
            <div className={styles.field}>
              ...
              <div className={styles.fieldWrap}>
                <input className={`${styles.input} ${styles.inputWithIcon}`}
                  type={showPass ? 'text' : 'password'} placeholder="Minim 8 caractere"
          ...
          <p className={styles.footer}>
            Ai deja cont?{' '}
            <Link to="/login">
              <button className={styles.footerBtn}>Autentifică-te</button>
            </Link>
          </p>
        </div>
